...
#ifndef _output_get_logs_H_
#define _output_get_logs_H_
...
typedef struct output_get_logs_t output_get_logs_t;

#include "response_log.h"



typedef struct output_get_logs_t {
    char *schema; // string
