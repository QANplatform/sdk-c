/*
 * output_get_transaction_by_block_hash_and_index.h
 *
 * 
 */

#ifndef _output_get_transaction_by_block_hash_and_index_H_
#define _output_get_transaction_by_block_hash_and_index_H_
...
typedef struct output_get_transaction_by_block_hash_and_index_t output_get_transaction_by_block_hash_and_index_t;

#include "response_transaction.h"



typedef struct output_get_transaction_by_block_hash_and_index_t {
    char *schema; // string
...
#endif /* _output_get_transaction_by_block_hash_and_index_H_ */
